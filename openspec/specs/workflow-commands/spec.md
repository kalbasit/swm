...
The `swm` command surface a developer drives directly: creating and removing stories, attaching projects to them, cloning repositories, opening and closing workspaces, and operating on the panes inside them.
