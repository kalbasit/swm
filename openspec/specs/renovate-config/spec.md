# Spec: renovate-config

## Purpose

Define the Renovate Bot configuration for the swm monorepo, covering all dependency ecosystems (Go modules, Nix flake inputs, GitHub Actions), scheduling, labeling, and merge policy.
